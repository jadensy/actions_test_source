...
ffa_membership AS (
    ...
    FROM
        ...
        left join marketing.fct_install_attribution_model__install_last_touch b on a.email=b.user_email and a.first_timestamp=b.lite_timestamp and a.product=b.ffa_product 
    WHERE
