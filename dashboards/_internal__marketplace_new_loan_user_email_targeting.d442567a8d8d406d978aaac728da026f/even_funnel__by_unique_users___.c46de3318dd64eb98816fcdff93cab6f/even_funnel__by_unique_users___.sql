...
, final_table AS (
  SELECT 
    ...
    enter_even_flow,
    users_submit_api,
    users_receive_offer as users_receive_loan_offer,
    users_click_loan_offer,
--     users_click_special_offer,
    even_loan_uniq_conv as user_convert_loan_offer,
...
, final_table_pct AS (
  SELECT 
    ...
    api_submit_rate, 
    receive_offer_rate, 
    click_loan_offer_rate, 
    convert_loan_offer_rate
  FROM final_table
  
)

select * from final_table_pct