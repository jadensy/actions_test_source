...
--     even_specialoff_uniq_conv as user_convert_special_offer,
    ...
    (submit_api * 1.00 / enter_even_flow) AS api_submit_rate,
    (receive_loan_offer * 1.00 / users_submit_api) AS receive_offer_rate,
    (click_loan_offer * 1.00 / receive_loan_offer) AS click_loan_offer_rate
--     (convert_loan_offer * 1.00 / click_loan_offer) AS convert_loan_offer_rate
