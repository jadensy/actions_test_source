...
on engagement.assignment_group = conversion.assignment_group and engagement.account_age_bucket = conversion.account_age_bucket
order by account_age_bucket, total_view desc