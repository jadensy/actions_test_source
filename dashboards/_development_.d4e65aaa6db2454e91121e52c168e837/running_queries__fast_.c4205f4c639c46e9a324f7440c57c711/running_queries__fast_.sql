...
select trim(u.usename) as user, s.pid,
q.query, decode(trim(q.service_class), '6', 'Long_queries', '7', 'Etls', '8', 'Analytics', '9', 'Periscope', '10', 'Segment', '11', 'Periscope_monitoring', '12', 'Default', trim(q.service_class)) as "queue", 
...
replace(trim(translate(s.text,chr(10)||chr(13)||chr(9) ,'')),'\\n', ' ') as sql
