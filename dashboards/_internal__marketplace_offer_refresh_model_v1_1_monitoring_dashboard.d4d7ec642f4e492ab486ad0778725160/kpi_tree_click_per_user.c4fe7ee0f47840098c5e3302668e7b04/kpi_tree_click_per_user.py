...
def tree_for_breakdown(metric_breakdown_df):
    ...
    metric_breakdown_df = metric_breakdown_df.loc[:,['assignment_group','partner','click_per_user']]
    parent_metric = metric_breakdown_df[['assignment_group','click_per_user']].groupby('assignment_group').sum()
