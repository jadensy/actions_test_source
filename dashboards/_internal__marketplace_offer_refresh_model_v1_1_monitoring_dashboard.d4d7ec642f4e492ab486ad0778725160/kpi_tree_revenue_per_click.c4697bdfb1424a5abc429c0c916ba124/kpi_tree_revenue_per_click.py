...
def tree_for_breakdown(metric_breakdown_df):
    ...
    metric_breakdown_df = metric_breakdown_df.loc[:,['assignment_group','partner','revenue_per_click']]
    parent_metric = metric_breakdown_df[['assignment_group','revenue_per_click']].groupby('assignment_group').sum()
