...
, engagement as (
  ...
  and assignment_group= 'live_rec_treatment_group'
  group by 1,2
  order by 1
)
...
select
  ...
  conversion.conversion_partner_name as "Conversion Partner Name",
...
on engagement.conversion_partner_name = conversion.conversion_partner_name
order by 4 DESC